...
<p>We’ll be putting in any <span className="hl-text-2">funding opportunities</span>, <span className="hl-text-2">open calls</span>, <span className="hl-text-2">residencies</span>, <span className="hl-text-2">workshops</span>, <span className="hl-text-2">events</span> and <span className="hl-text-2">online resources</span> that are applicable to new media artists and creative technologists. It will be sent out on the <b>1st and 15th of every month</b>. That’s it for now. 
</p>
